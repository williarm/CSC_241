	...
	public void computeScoreFrame() {
		...
		if (f >= 2) { // look two frames back
			...
			if (scores[f - 2][0] == 10 && scores[f - 1][0] == 10) {
				...
				System.out.println("Score in the frame: "+(((scores[f][0] * 2 + scores[f][1]) + (scores[f][0] + scores[f][1]))));
			...
			// strike last 1 frame
				...
				System.out.println("Score in the frame: " + (((scores[f][0] + scores[f][1]) * 2)));
			...
			// spare last frame
				...
				System.out.println("Score in the frame: " + ((scores[f][0] * 2) + scores[f][1]));
			...
			// regular score tracking
				...
				System.out.println("Score in the frame: " + ((scores[f][0] + scores[f][1])));
...

		{
			...
			if ((scores[f - 1][0] != 10) && (scores[f - 1][0] + scores[f - 1][1] == 10)) {// spare last frame
				// score + throw1 * 2 + throw 2
				System.out.println("Score in the frame: " + ((scores[f][0] * 2) + scores[f][1]));
				score += (scores[f][0] * 2) + scores[f][1];
