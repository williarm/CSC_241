...
public class LLNode<T> {
	...
	/**
	 * Purpose: The LLNode constructor accepts an object of class T
	 * as an argument and sets the info variable to that object.
	 * 
	 * @param info Object of class T
	 * @return nothing
	 * 
	 */
	 ...
	 * 
	 * @param LLNode<T> link reference to a node
	 * @return nothing
	 * 
	 */
